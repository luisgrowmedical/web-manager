...
<div class="card" style="overflow-x: auto;">
    <div style="min-width: 1000px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; padding-bottom: 16px; border-bottom: 1px solid var(--border-color);">
            ...
            <a href="/web-manager/public/index.php?route=sites&action=add" class="btn btn-primary" style="padding: 12px 24px; font-weight: 800; font-size: 15px; box-shadow: 0 4px 12px rgba(99, 102, 241, 0.4); border-radius: 9999px; display: flex; align-items: center; gap: 8px;">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th><?php echo sortLink('Updates', 'updates_count', $filters); ?></th>
                    ...
                    <?php else: ?>
                        <?php foreach ($sites as $site): ?>
                            <tr>
                                ...
                                <td>
                                    <?php if (isset($site['updates_count']) && $site['updates_count'] > 0): ?>
                                        <span style="color: #dc2626; font-weight: bold;"><?php echo $site['updates_count']; ?></span>
                                    <?php else: ?>
                                        <?php echo isset($site['updates_count']) ? $site['updates_count'] : '-'; ?>
                                    <?php endif; ?>
                                </td>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; padding: 16px; border-top: 1px solid var(--border-color); margin-top: 16px;">
